...
public class ReadEducation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_education);
        ...
        reference = FirebaseDatabase.getInstance().getReference("Education").child(postid);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                post_body.setText(newsModel.getBody());
            }
